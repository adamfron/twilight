...
export interface Station { id: string; name: string; latitude: number; longitude: number; altitudeM: number; approx?: boolean; timeZone?: string; }
export interface SolarPosition { elevationDeg: number; azimuthDeg: number; declinationDeg: number; }
